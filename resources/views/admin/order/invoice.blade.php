    ...
    <div class="invoice-box">
        <table>
            ...
            <tr class="item">
                ...
                <td class="text-right">{{number_format($orderDetail->product_qty * $orderDetail->product_price)}}</td>
            </tr>
            ...
            <tr class="total">
                ...
                @php($tax = ($sum*15)/100)
                <td class="text-right">{{round($tax)}}</td>
            </tr>

            <tr class="total">
                <td colspan="3">Shipping Total :</td>
                <td class="text-right">{{number_format($order->shipping_total)}}</td>
            </tr>
            <tr class="total">
                <td colspan="3">Total Payable :</td>
                <td class="text-right">{{number_format($sum + $tax + $order->shipping_total)}}</td>
            </tr>
            <tr class="total">
