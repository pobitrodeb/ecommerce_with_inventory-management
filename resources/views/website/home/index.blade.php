    ...
    <section class="trending-product section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2> Latest Trending Product</h2>
                        <p>Dynamik By Pobitro Debnath .</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            ...
                            <div class="button">
                                ...
                                <button type="submit" href="" class="btn"><i class="lni lni-cart"></i> Add to Cart</button>
                            </div>
                        ...
                        <div class="product-info">
                            ...
                            <h4 class="title">
                                <a href="{{route('product.detailPage',['id'=>$product->id])}}">{{$product->name}}</a>
                            </h4>
                            <ul class="review">
                            ...
                            <div class="price">
                                <span> TK {{$product->selling_price}} <s>{{$product->regular_price}}</s></span>
                            </div>
                        </div>
                    </div>
                </div>
