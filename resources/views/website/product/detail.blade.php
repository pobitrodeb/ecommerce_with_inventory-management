                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> Brand:<a href="javascript:void(0)">{{$products->brand->name}}</a></p>
                            <h3 class="price">TK:{{$products->selling_price}}<span>{{$products->regular_price}}</span></h3>
