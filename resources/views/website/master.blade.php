                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="top-end">
                        ...
                        @else
                            <ul class="user-login">
                                <li>
                                    <a href="{{route('customer.login')}}">Sing In</a>
                                </li>
                                <li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-3 col-7">
                    ...
                    <a class="navbar-brand" href="{{route('home')}}">
                        ...
                        {{-- <img src="{{asset('/')}}website/assets/images/logo/pobitrodebLogo.jpg" alt="Logo"> --}}
                        <h3> POBITRO </h3>
                                        ...
                                        <li>
                                            ...
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="product-details.html">
                                                    <img src="{{asset($cartProduct->attributes->image)}}" alt=""/>
                                                </a>
                                            </div>
                                            <div class="content">
                ...
                <div class="nav-inner">
                    ...
                    <div class="mega-category-menu">
                        ...
                        <ul class="sub-category">
                            ...
                            <li><a href="{{route('category.detail',['id'=>$category->id])}}">{{$category->name}}
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="footer-logo">
                            <a href="index.html">
                                ...
                                <h3 class="text-white">POBITRO </h3>
                            </a>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="inner-content">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="copyright">
                            <p> Developed by<a href="www.pobitrodeb.com" rel="nofollow" target="_blank">pobitrodeb</a></p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">
                        <ul class="socila">
